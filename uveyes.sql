...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$390000$JfOXIsEcFOaUHQGIarH0qZ$C260QFqpdCaHtQGElwk5NGyYR/SMBJVpBx8xbfK2Bpk=','2023-04-04 08:02:30.890535',1,'santiagoi','','','san20052@gmail.com',1,1,'2023-04-04 08:02:13.333268');
...
INSERT INTO `django_admin_log` VALUES (1,'2023-04-05 06:26:30.195773','4','usuario object (4)',1,'[{\"added\": {}}]',8,1),(2,'2023-04-05 06:26:35.839884','4','usuario object (4)',2,'[]',8,1),(3,'2023-04-05 06:46:08.749261','1','7.0 - Santiago',2,'[]',9,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(9,'usuarios','busqueda'),(7,'usuarios','registro'),(8,'usuarios','usuario');
...
INSERT INTO `django_session` VALUES ('gskoz4tbivb08w4ir4jpd0x0lwsavkhl','.eJxVjMsOwiAQRf-FtSEwMwi4dN9vIDylaiAp7cr479qkC93ec859Mee3tbpt5MXNiV2YZKffLfj4yG0H6e7brfPY27rMge8KP-jgU0_5eT3cv4PqR_3WKMGAJRHQJIWl6BiMjNogEp3J2wCCDCijgtZYSCivhSS0ANZCLJa9P6TqNgE:1pjbcc:fx_FDi4BEljVa8YDSk0giSqBObAGOTS4tyvARG1anfY','2023-04-18 08:02:30.927540');
...
CREATE TABLE `uvapp_busqueda` (
  ...
  PRIMARY KEY (`id`),
  KEY `usuarios_busqueda_usuario_id_2df36dd0_fk_usuarios_usuario_id` (`usuario_id`),
  CONSTRAINT `usuarios_busqueda_usuario_id_2df36dd0_fk_usuarios_usuario_id` FOREIGN KEY (`usuario_id`) REFERENCES `uvapp_usuario` (`id`)
...
INSERT INTO `uvapp_busqueda` VALUES (1,'Medellin',7,1),(2,'Marinilla',3,3);
...
CREATE TABLE `uvapp_usuario` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `usuarios_usuario_age_0a93b5db_check` CHECK ((`age` >= 0))
...
INSERT INTO `uvapp_usuario` VALUES (1,'Santiago','Idarraga','Medellin',17),(2,'Miguel','Aguilar','Medellin',17),(3,'Juan','Zuluaga','Marinilla',17),(4,'Jose','Idarraga','Medellín',78);
...
-- Dump completed on 2023-04-17 23:16:21
